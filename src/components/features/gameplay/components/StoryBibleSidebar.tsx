          ...
          >
            <motion.div
              ...
              className={`bg-[#020617]/95 backdrop-blur-md border border-slate-800/80 flex flex-col overflow-hidden text-slate-100 shadow-[0_12px_40px_rgba(0,0,0,0.6)] duration-300 relative ${
                isMaximized 
                  ? (resolvedInterfaceMode === 'mobile' ? "" : "fixed inset-0 w-screen h-screen rounded-none border-0 z-[1001]") 
                  : (resolvedInterfaceMode === 'mobile' ? "" : "w-[95vw] max-w-[1400px] h-[90vh] rounded-2xl")
              }`}
              style={resolvedInterfaceMode === 'mobile' ? (
                isMaximized ? {
                  zoom: 2.0,
                  width: '100vw',
                  height: '100vh',
